...
자기 차량을 등록하는 빈 화면으로 시작합니다. 개발자의 차량·정비 원본·사진·개인값은 포함하지 않습니다. 기록은 기기에 보관하고, 영수증 인식 결과는 사용자가 확인한 뒤 저장합니다. 관리 → 알림·백업·기록 도구 → 앱 정보·업데이트에서 업데이트를 확인하거나 자동 확인을 끌 수 있습니다. 삭제·분실에 대비해 백업을 별도로 보관하세요.
